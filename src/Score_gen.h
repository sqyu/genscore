...
double sum(int len, double *v);
double in_order_dot_prod(int len, double *l, double *r);
double in_order_tri_dot_prod(int len, double *l, double *m, double *r);
double in_order_dot_prod_pow(int len, double *l, double *r, double lpow, double rpow);
double in_order_tri_dot_prod_pow(int len, double *l, double *m, double *r, double lpow, double mpow, double rpow);
